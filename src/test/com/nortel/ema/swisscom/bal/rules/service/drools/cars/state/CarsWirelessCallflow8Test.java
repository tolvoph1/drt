 ...
 *
 * $Id: CarsWirelessCallflow8Test.java 156 2013-12-10 08:00:59Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class CarsWirelessCallflow8Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;
	private static final String RULES_FILE_NAME = "cars/wireless-callflow8";
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CarsWirelessCallflow8Test.class);
	}
	...
	public final void testID010_181201_Init_Workflow() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "Init");

		expectedResult.setAction(SE_ACTION_ADDSTATISTIC);
		expectedResult.setOutputVar1("181201");
		expectedResult.setNextState("AskAboutCreditlimitInfo");
	...
	public final void testID020_AskAboutCreditlimitInfo() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "AskAboutCreditlimitInfo");

		expectedResult.setAction(SE_ACTION_INPUT);
		expectedResult.setOutputVar1("FragenKreditlimiteTaste1UebrigeFragenTaste2");
		expectedResult.setOutputVar2("5s");
		expectedResult.setOutputVar3("2");
		expectedResult.setNextState("CheckInputAskAboutCreditlimitInfo");
	...
	public final void testID030a_181204_CheckInputAskAboutCreditlimitInfo_Input_1() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfo");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"SUCCESS");
		callProfile.put(CPK_CARS_ACTIONRESPONSEVALUE,"1");

		expectedResult.setAction(SE_ACTION_ADDSTATISTIC);
		expectedResult.setOutputVar1("181204");
		expectedResult.setNextState("SpeakRemainingBalance");
	...
	public final void testID030b_181205_CheckInputAskAboutCreditlimitInfo_Input_2() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfo");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"SUCCESS");
		callProfile.put(CPK_CARS_ACTIONRESPONSEVALUE,"2");

		expectedResult.setAction(SE_ACTION_ADDSTATISTIC);
		expectedResult.setOutputVar1("181205");
	...
	public final void testID030c_181206_CheckInputAskAboutCreditlimitInfo_NoInput() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfo");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"NOINPUT");

		expectedResult.setAction(SE_ACTION_ADDSTATISTIC);
		expectedResult.setOutputVar1("181206");
		expectedResult.setNextState("SpeakPleaseSelectAfter181206");
	...
	public final void testID030d_181206_CheckInputAskAboutCreditlimitInfo_NoMatch() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfo");
	...
	public final void testID040_SpeakPleaseSelectAfter181206() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "SpeakPleaseSelectAfter181206");
		...
		expectedResult.setNextState("AskAboutCreditlimitInfoSecondTime");
	...
	public final void testID050_AskAboutCreditlimitInfoSecondTime() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "AskAboutCreditlimitInfoSecondTime");

		expectedResult.setAction(SE_ACTION_INPUT);
		expectedResult.setOutputVar1("FragenKreditlimiteTaste1UebrigeFragenTaste2");
		expectedResult.setOutputVar2("5s");
		expectedResult.setOutputVar3("2");
		expectedResult.setNextState("CheckInputAskAboutCreditlimitInfoSecondTime");
	...
	public final void testID060a_181209_CheckInputAskAboutCreditlimitInfoSecondTime_Input_1() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfoSecondTime");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"SUCCESS");
		callProfile.put(CPK_CARS_ACTIONRESPONSEVALUE,"1");

		expectedResult.setAction(SE_ACTION_ADDSTATISTIC);
		expectedResult.setOutputVar1("181209");
		expectedResult.setNextState("SpeakRemainingBalance");
	...
	public final void testID060b_181208_CheckInputAskAboutCreditlimitInfoSecondTime_Input_2() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfoSecondTime");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"SUCCESS");
		callProfile.put(CPK_CARS_ACTIONRESPONSEVALUE,"2");

		expectedResult.setAction(SE_ACTION_ADDSTATISTIC);
		expectedResult.setOutputVar1("181208");
		expectedResult.setNextState("Back2Portal");
	...
	public final void testID060c_181207_CheckInputAskAboutCreditlimitInfoSecondTime_NoInput() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfoSecondTime");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"NOINPUT");

		expectedResult.setAction(SE_ACTION_ADDSTATISTIC);
		expectedResult.setOutputVar1("181207");
		expectedResult.setNextState("SpeakPleaseSelectAfter181207");
	...
	public final void testID060d_181207_CheckInputAskAboutCreditlimitInfoSecondTime_NoMatch() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfoSecondTime");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"NOMATCH");
	...
	public final void testID070_SpeakPleaseSelectAfter181207() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "SpeakPleaseSelectAfter181207");

		expectedResult.setAction(SE_ACTION_SPEAK);
		expectedResult.setOutputVar1("portal:BitteOptionWaehlen");
		expectedResult.setOutputVar2("false");
		expectedResult.setOutputVar3("false");
		expectedResult.setNextState("AskAboutCreditlimitInfoThirdTime");
	...
	public final void testID080_AskAboutCreditlimitInfoThirdTime() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "AskAboutCreditlimitInfoThirdTime");

		expectedResult.setAction(SE_ACTION_INPUT);
		expectedResult.setOutputVar1("FragenKreditlimiteTaste1UebrigeFragenTaste2");
		expectedResult.setOutputVar2("5s");
		expectedResult.setOutputVar3("2");
		expectedResult.setNextState("CheckInputAskAboutCreditlimitInfoThirdTime");
	...
	public final void testID090a_181209_CheckInputAskAboutCreditlimitInfoThirdTime_Input_1() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfoThirdTime");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"SUCCESS");
		callProfile.put(CPK_CARS_ACTIONRESPONSEVALUE,"1");
	...
	public final void testID090b_181208_CheckInputAskAboutCreditlimitInfoThirdTime_Input_2() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfoThirdTime");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"SUCCESS");
		callProfile.put(CPK_CARS_ACTIONRESPONSEVALUE,"2");
	...
	public final void testID090c_181208_CheckInputAskAboutCreditlimitInfoThirdTime_NoInput() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfoThirdTime");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"NOINPUT");
	...
	public final void testID090d_181208_CheckInputAskAboutCreditlimitInfoThirdTime_NoMatch() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckInputAskAboutCreditlimitInfoThirdTime");
		callProfile.put(CPK_CARS_ACTIONRESPONSE,"NOMATCH");
	...
	public final void testID100_SpeakRemainingBalance() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "SpeakRemainingBalance");

		customerProfile.setRemainingCredit("10");

		expectedResult.setAction(SE_ACTION_SPEAK);
		expectedResult.setOutputVar1("portal:RestguthabenBetraegtA"+
						   " ttaCurrency:"+customerProfile.getRemainingCredit()+
						   " portal:RestguthabenBetraegtB");
		expectedResult.setOutputVar2("true");
		expectedResult.setOutputVar3("false");
		expectedResult.setNextState("AddStatistic181203");
	...
	public final void testID110_181203_AddStatistic() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "AddStatistic181203");

		expectedResult.setAction(SE_ACTION_ADDSTATISTIC);
		expectedResult.setOutputVar1("181203");
