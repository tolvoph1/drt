 ...
 *
 * $Id: CBURulesState0080072472424Test.java 107 2013-09-10 22:40:41Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class CBURulesState0080072472424Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "cbu/vp5cbu-0080072472424-state";
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesState0080072472424Test.class);
	}
	...
	public final void testID130_MenuLevel1() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0080072472424-menu-level1");
		expectedResult.setOutputVar2("CBU-WIRELINE");
		expectedResult.setOutputVar3("cbu/vp5cbu-0080072472424-menu-level1");
	...
	public final void testID140_CheckMenuSelectionLevel1AnotherMenuLevel() throws Exception {
		...
		expectedResult.setAction(SE_ACTION_EXTENDEDMENU);
		expectedResult.setOutputVar1("cbu/vp5cbu-0080072472424-menu-level2");
		expectedResult.setOutputVar2("CBU-WIRELINE");
		expectedResult.setOutputVar3("cbu/vp5cbu-0080072472424-menu-level2");
	...
	public final void testID200_Transfer() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0080072472424-transfer");
		expectedResult.setNextState("Disconnect");
