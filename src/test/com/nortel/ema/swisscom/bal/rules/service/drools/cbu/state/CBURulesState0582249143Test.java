 ...
 *
 * $Id: CBURulesState0582249143Test.java 78 2013-09-09 15:18:53Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class CBURulesState0582249143Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "cbu/vp5cbu-0582249143-state";
	...
	protected void setUp() {
		...
		callProfile.setBusinessnumber(BUSINESSNUMBER_0582249143);
		callProfile.setBusinesstyp(CBU);
		aniList = new ArrayList<String>();
	}

	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesState0582249143Test.class);
	}
	...
	public final void testID110_Transfer() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0582249143-transfer");
