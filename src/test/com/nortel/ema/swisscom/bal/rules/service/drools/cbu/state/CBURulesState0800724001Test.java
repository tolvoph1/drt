 ...
 *
 * $Id: CBURulesState0800724001Test.java 78 2013-09-09 15:18:53Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class CBURulesState0800724001Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "cbu/vp5cbu-0800724001-state";
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesState0800724001Test.class);
	}
	...
	protected void setUp() {
		...
		callProfile.put(CPK_BUSINESSNUMBER, BUSINESSNUMBER_0800724001);
	...
	public final void testID130_EmergencyAnnouncements() throws Exception {
		...
		expectedResult.setOutputVar1("CBU-AXA");
	...
	public final void testID140_MenuLevel1() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0800724001-menu-level1");
		expectedResult.setOutputVar2("CBU-AXA");
		expectedResult.setOutputVar3("cbu/vp5cbu-0800724001-menu-level1");
	...
	public final void testID150_CheckMenuSelectionLevel1AnotherMenuLevel() throws Exception {
		...
		expectedResult.setAction(SE_ACTION_EXTENDEDMENU);
		expectedResult.setOutputVar1("cbu/vp5cbu-0800724001-menu-level2");
		expectedResult.setOutputVar2("CBU-AXA");
		expectedResult.setOutputVar3("cbu/vp5cbu-0800724001-menu-level2");
	...
	public final void testID200_Transfer() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0800724001-transfer");
