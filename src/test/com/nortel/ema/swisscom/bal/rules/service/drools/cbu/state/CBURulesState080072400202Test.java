 ...
 *
 * $Id: CBURulesState080072400202Test.java 82 2013-09-10 08:29:21Z tolvoph1 $
 * $Author: tolvoph1 $
 * $Date: 2013-09-10 10:29:21 +0200 (Tue, 10 Sep 2013) $
 * $Revision: 82 $
 * 
 */
...
public class CBURulesState080072400202Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "cbu/vp5cbu-080072400202-state";
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesState080072400202Test.class);
	}
	...
	protected void setUp() {
		...
		callProfile.put(CPK_BUSINESSNUMBER, BUSINESSNUMBER_080072400202);
	...
	public final void testID140_MenuLevel1() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-080072400202-menu-level1");
		expectedResult.setOutputVar2("CBU-CS");
		expectedResult.setOutputVar3("cbu/vp5cbu-080072400202-menu-level1");
	...
	public final void testID150_CheckMenuSelectionLevel1AnotherMenuLevel() throws Exception {
		...
		expectedResult.setAction(SE_ACTION_EXTENDEDMENU);
		expectedResult.setOutputVar1("cbu/vp5cbu-080072400202-menu-level2");
		expectedResult.setOutputVar2("CBU-CS");
		expectedResult.setOutputVar3("cbu/vp5cbu-080072400202-menu-level2");
	...
	public final void testID200_Transfer() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-080072400202-transfer");
