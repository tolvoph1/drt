 ...
 *
 * $Id: CBURulesState0800724002Test.java 78 2013-09-09 15:18:53Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class CBURulesState0800724002Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "cbu/vp5cbu-0800724002-state";
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesState0800724002Test.class);
	}
	...
	protected void setUp() {
		...
		callProfile.put(CPK_BUSINESSNUMBER, BUSINESSNUMBER_0800724002);
	...
	public final void testID140_MenuLevel1() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0800724002-menu-level1");
		expectedResult.setOutputVar2("CBU-CS");
		expectedResult.setOutputVar3("cbu/vp5cbu-0800724002-menu-level1");
	...
	public final void testID150_CheckMenuSelectionLevel1AnotherMenuLevel() throws Exception {
		...
		expectedResult.setAction(SE_ACTION_EXTENDEDMENU);
		expectedResult.setOutputVar1("cbu/vp5cbu-0800724002-menu-level2");
		expectedResult.setOutputVar2("CBU-CS");
		expectedResult.setOutputVar3("cbu/vp5cbu-0800724002-menu-level2");
	...
	public final void testID200_Transfer() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0800724002-transfer");
