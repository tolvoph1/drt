 ...
 *
 * $Id: CBURulesState0800724008Test.java 83 2013-09-10 08:42:24Z tolvoph1 $
 * $Author: tolvoph1 $
 * $Date: 2013-09-10 10:42:24 +0200 (Tue, 10 Sep 2013) $
 * $Revision: 83 $
 * 
 */
...
public class CBURulesState0800724008Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "cbu/vp5cbu-0800724008-state";
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesState0800724008Test.class);
	}
	...
	protected void setUp() {
		...
		callProfile.put(CPK_BUSINESSNUMBER, BUSINESSNUMBER_0800724008);
	...
	public final void testID130_EmergencyAnnouncements() throws Exception {
		...
		expectedResult.setOutputVar1("CBU-POST");
	...
	public final void testID140_MenuLevel1() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0800724008-menu-level1");
		expectedResult.setOutputVar2("CBU-POST");
		expectedResult.setOutputVar3("cbu/vp5cbu-0800724008-menu-level1");
	...
	public final void testID150_CheckMenuSelectionLevel1AnotherMenuLevel() throws Exception {
		...
		expectedResult.setAction(SE_ACTION_EXTENDEDMENU);
		expectedResult.setOutputVar1("cbu/vp5cbu-0800724008-menu-level2");
		expectedResult.setOutputVar2("CBU-POST");
		expectedResult.setOutputVar3("cbu/vp5cbu-0800724008-menu-level2");
	...
	public final void testID200_Transfer() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0800724008-transfer");
