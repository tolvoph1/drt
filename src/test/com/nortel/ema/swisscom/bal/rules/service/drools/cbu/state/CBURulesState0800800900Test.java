 ...
 *
 * $Id: CBURulesState0800800900Test.java 236 2014-04-15 12:36:40Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class CBURulesState0800800900Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "cbu/vp5cbu-0800800900-state";
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesState0800800900Test.class);
	}
	...
	protected void setUp() {
		...
		callProfile.put(CPK_BUSINESSNUMBER, BUSINESSNUMBER_0800800900);
	...
	public final void testID140_MenuLevel1() throws Exception {
		...
		expectedResult.setOutputVar3("cbu/vp5cbu-0800800900-menu-level1");
	...
	public final void testID190_Transfer() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0800800900-transfer");
		expectedResult.setNextState("Disconnect");
