 ...
 *
 * $Id: CBURulesState0812879948Test.java 78 2013-09-09 15:18:53Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class CBURulesState0812879948Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "cbu/vp5cbu-0812879948-state";
	...
	protected void setUp() {
		...
		callProfile.setBusinessnumber(BUSINESSNUMBER_0812879948);
		callProfile.setBusinesstyp(CBU);
		aniList = new ArrayList<String>();
	}

	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesState0812879948Test.class);
	}
	...
	public final void testID140_Transfer() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0812879948-transfer");
