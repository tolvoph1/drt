 ...
 *
 * $Id: CBURulesState0812879963Test.java 78 2013-09-09 15:18:53Z tolvoph1 $
 * $Author: tolvoph1 $
 * $Date: 2013-09-09 17:18:53 +0200 (Mon, 09 Sep 2013) $
 * $Revision: 78 $
 * 
 * Migrated from VP5CBURulesState0812879963Test.java as the BN has been updated (CRQ2011-042)
 */
...
public class CBURulesState0812879963Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "cbu/vp5cbu-0812879963-state";
	...
	protected void setUp() {
		...
		callProfile.setBusinessnumber(BUSINESSNUMBER_0582249151);
		callProfile.setBusinesstyp(CBU);
		aniList = new ArrayList<String>();
	}

	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesState0812879963Test.class);
	}
	...
	public final void testID140_Transfer() throws Exception {
		...
		expectedResult.setOutputVar1("cbu/vp5cbu-0812879963-transfer");
