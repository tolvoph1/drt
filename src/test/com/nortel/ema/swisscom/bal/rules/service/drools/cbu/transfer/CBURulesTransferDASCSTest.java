 ...
 *
 * $Id: CBURulesTransferDASCSTest.java 227 2014-03-31 07:31:26Z tolvoph1 $
 * $Author: tolvoph1 $
 * $Date: 2014-03-31 09:31:26 +0200 (Mon, 31 Mar 2014) $
 * $Revision: 227 $
 * 
 *  Testklasse für die DAS CS Businessnummern:
 * - 058 224 91 51
 * - 081 287 99 63 
 */
...
public class CBURulesTransferDASCSTest extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final ArrayList<String> rules = new ArrayList<String>(
			Arrays.asList(
					"cbu/vp5cbu-0582249151-transfer",
					"cbu/vp5cbu-0812879963-transfer"
					));
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(CBURulesTransferDASCSTest.class);
	}
	...
	public final void testID0920() throws Exception {
		for (String RULES_FILE_NAME: rules) {
			...
			checkTransferRulesResult(RULES_FILE_NAME, "40920", "7523", transferRulesState);
		}
	}

	public final void testID1003() throws Exception {
		for (String RULES_FILE_NAME: rules) {

			transferRulesState = droolsImpl.getTransferQueue(RULES_FILE_NAME, customerProfile,
					customerProducts, customerProductClusters, callProfile, serviceConfiguration);

			checkTransferRulesResult(RULES_FILE_NAME, "41003", "7523", transferRulesState);
		}
	}
}
