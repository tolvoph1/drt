 ...
 *
 * $Id: IPhone5SMETest.java 78 2013-09-09 15:18:53Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class IPhone5SMETest extends TestCase {
	...
	private static final String RULESFILENAME = "inas/iphone5-sme";
	 ...
	 */
	 public static void main(final String[] args) {
		 junit.textui.TestRunner.run(IPhone5SMETest.class);
	 }
	 ...
	 public final void test_Menu() throws Exception {
		 ...
		 assertEquals("8555", menuOptions.get(1).getRoutingID());
		 assertEquals("2930", menuOptions.get(1).getReasonCode());
	 }    
}
