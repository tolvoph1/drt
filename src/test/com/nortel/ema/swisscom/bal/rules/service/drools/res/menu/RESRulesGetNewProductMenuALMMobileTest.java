 ...
 *
 * $Id: RESRulesGetNewProductMenuALMMobileTest.java 79 2013-09-09 15:24:23Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class RESRulesGetNewProductMenuALMMobileTest extends TestCase {
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(RESRulesGetNewProductMenuALMMobileTest.class);
	}

	public final void test_Static_NewProductMenu_Mobile() throws Exception {

		menuOptions = droolsImpl.getExtendedMenuOptions(ONEIVRRES_NEWPRODUCT_MENU_ALM_MOBILE, customerProfile, customerProducts, customerProductClusters, callProfile,
