 ...
 *
 * $Id: RESRulesState0800800851Test.java 233 2014-04-08 06:19:14Z tolvoph1 $
 * $Author: tolvoph1 $
 * $Date: 2014-04-08 08:19:14 +0200 (Tue, 08 Apr 2014) $
 * $Revision: 233 $
 * $URL: http://sol47658/svn/BAL_Rules/trunk/BAL_Rules/src/test/com/nortel/ema/swisscom/bal/rules/service/drools/res/state/RESRulesState0800800851Test.java $
 */
...
public class RESRulesState0800800851Test extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static final String RULES_FILE_NAME = "oneIVR/vp5res-0800800851-state";
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(RESRulesState0800800851Test.class);
	}
	...
	protected void setUp() {
		...
		callProfile.setBusinessnumber(BUSINESSNUMBER_0800800851);
	...
	public final void testID100_GetINAS() throws Exception {
		...
		expectedResult.setOutputVar1("RES-OS");
	...
	public final void testID120_OpeningHours() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "OpeningHours");

		expectedResult.setAction(SE_ACTION_CHECKOH);
		expectedResult.setOutputVar1("OH_RES_ONLINESHOP");
	...
	public final void testID130a_CheckOHResult_Closed() throws Exception {
	...
	public final void testID130b_CheckOHResult_Open() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckOHResult");
	...
	public final void testID140_MenuLevel1() throws Exception {
		...
		expectedResult.setOutputVar1("oneIVRresAnliegenMenuOnlineShop");
		expectedResult.setOutputVar3("oneIVR/vp5resAnliegenMenuOnlineShop");
	...
	public final void testID150_CheckMenuLevel1Response_Transfer() throws Exception {
