 ...
 *
 * $Id: SMERulesGetNewProductMenuPRMFixnetTest.java 113 2013-09-11 09:52:51Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class SMERulesGetNewProductMenuPRMFixnetTest extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;

	private static String RULES_FILE_NAME = RULES_SME_NPPRMMENU_FIXNET;
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(SMERulesGetNewProductMenuPRMFixnetTest.class);
	}
	...
	public final void test_ProductMenu_ALM2_Fixnet() throws Exception {
		...
		expectedMenuOptions.add(smeNPAlm2Prm4());
		expectedMenuOptions.add(smeNPAlm2Prm5());
		compareExpectedToActual(expectedMenuOptions, menuOptions);
	}
