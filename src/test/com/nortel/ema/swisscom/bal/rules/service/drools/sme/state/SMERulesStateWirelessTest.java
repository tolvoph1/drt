 ...
 *
 * $Id: SMERulesStateWirelessTest.java 169 2014-01-24 14:44:16Z tolvoph1 $
 * $Author: tolvoph1 $
...
public class SMERulesStateWirelessTest extends TestCase {

	private static RulesServiceDroolsImpl droolsImpl;
	private static String RULES_FILE_NAME = "sme/vp5sme-wireless-state";
	...
	public static void main(final String[] args) {
		junit.textui.TestRunner.run(SMERulesStateWirelessTest.class);
	}
	...
	public final void testID010_InitWirelessPers() throws Exception {
	...
	public final void testID020_CheckOH_NewProductMenu() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckOHNewProductMenu");

		expectedResult.setAction(SE_ACTION_CHECKOH);
		expectedResult.setOutputVar1("OH_SME_NEWPRODUCT_WIRELESS");
	...
	public final void testID030b_NewProductMenuLevel1_Open() throws Exception {
		...
		expectedResult.setOutputVar1("smeNPAlmMenuMobile");
		expectedResult.setOutputVar3("sme/vp5smeNPAlmMenuMobile");
	...
	public final void testID050_NewProductMenuLevel2() throws Exception {
		...
		expectedResult.setAction(SE_ACTION_EXTENDEDMENU);
		expectedResult.setOutputVar1("smeNPPrmMenuMobile");
		expectedResult.setOutputVar3("sme/vp5smeNPPrmMenuMobile");
	...
	public final void testID130a_PersonalisationCheck1_mobilegesperrt_Transfer() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "PersonalisationCheck1");

		for (int obi=0;obi<=1;obi++) {
			for (int obo=0;obo<=1;obo++) {
				// Continue if both are 0
				if (obi==0 && obo==0)
					continue;
				customerProfile.setObi(new Integer(obi).toString());
				customerProfile.setObo(new Integer(obo).toString());
	...
	public final void testID130b_Personalisation_Check1_not_mobilegesperrt_Proceed() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "PersonalisationCheck1");
	...
	public final void testID220a2_MenuLevel1Response_Transfer_Diffkube() throws Exception {
		...
		for (String actionResponse: actionResponses) {
			for (String menu: menus) {
				callProfile.put(CPK_ACTIONRESPONSE, actionResponse);
				callProfile.put(SME_ANLIEGENMENU,menu);
	...
	public final void testID260c2_MenuLevel2Response_Rechnung_SME_no_Seiteneinstieg_numberChanged() throws Exception {
		...
		callProfile.put(CPK_PHONENUMBER,"+41419213930");
	...
	public final void testID260c3_MenuLevel2Response_Rechnung_SME_no_Seiteneinstieg_numberUnchanged() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "CheckMenuLevel2Response");
		callProfile.put(CPK_ACTIONRESPONSE, "RECHNUNG");
		callProfile.put(CPK_ANI,"0419213930");
		callProfile.put(CPK_PHONENUMBER,"+41419213930");
	...
	public final void testID360b_CheckClosedKMUConfirm_No() throws Exception {
		...
		expectedResult.setAction(SE_ACTION_PROCEED);
		expectedResult.setNextState("ClosedKMUSendSMS");
	...
	public final void testID370a_ClosedKMUSendSMS_DE() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "ClosedKMUSendSMS");
		callProfile.setLanguage(CPV_LANGUAGE_G);
		callProfile.setPhonenumber("123456");

		expectedResult.setAction(SE_ACTION_SENDSMS);
		expectedResult.setOutputVar1("NONOFFICEHOURSDE");
		expectedResult.setOutputVar2(callProfile.getPhonenumber());
	...
	public final void testID370b_ClosedKMUSendSMS_FR() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "ClosedKMUSendSMS");
		callProfile.setLanguage(CPV_LANGUAGE_F);
		callProfile.setPhonenumber("12345");

		expectedResult.setAction(SE_ACTION_SENDSMS);
		expectedResult.setOutputVar1("NONOFFICEHOURSFR");
		expectedResult.setOutputVar2(callProfile.getPhonenumber());
		expectedResult.setNextState("Disconnect");
	...
	public final void testID370c_ClosedKMUSendSMS_IT() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "ClosedKMUSendSMS");
		callProfile.setLanguage(CPV_LANGUAGE_I);
		callProfile.setPhonenumber("1234");

		expectedResult.setAction(SE_ACTION_SENDSMS);
		expectedResult.setOutputVar1("NONOFFICEHOURSIT");
		expectedResult.setOutputVar2(callProfile.getPhonenumber());
		expectedResult.setNextState("Disconnect");
	...
	public final void testID370d_ClosedKMUSendSMS_EN() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "ClosedKMUSendSMS");
		callProfile.setLanguage(CPV_LANGUAGE_E);
		callProfile.setPhonenumber("123");

		expectedResult.setAction(SE_ACTION_SENDSMS);
		expectedResult.setOutputVar1("NONOFFICEHOURSEN");
		expectedResult.setOutputVar2(callProfile.getPhonenumber());
		expectedResult.setNextState("Disconnect");
	...
	public final void testID370e_ClosedKMUSendSMS_Fallback() throws Exception {
		callProfile.put(CPK_NEXTSTATE, "ClosedKMUSendSMS");
